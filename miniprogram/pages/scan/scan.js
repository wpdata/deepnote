Page({
  ...
  // 降级到整页识别
  async fallbackToFullPage(fileID) {
    ...
    try {
      ...
      if (ocrRes.result.success) {
        const aiAnalysis = ocrRes.result.aiAnalysis || {}
        ...
        this.setData({
          ...
          formattedQuestions: [{
            ...
            index: 0,
            croppedImage: null,
            formattedText: ocrRes.result.text,
            rawText: ocrRes.result.text,
